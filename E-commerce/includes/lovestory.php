...
<div class="product-grid">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/monstera.webp" alt="Monstera Deliciosa">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Monstera Deliciosa</h3>
                            <p class="product-description">Also known as Swiss Cheese Plant, with beautiful fenestrated leaves.</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/peace.jpg" alt="Peace Lily">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Peace Lily</h3>
                            <p class="product-description">Elegant white flowers and glossy leaves. Great air purifier.</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/snake.jpg" alt="Snake Plant">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Snake Plant</h3>
                            <p class="product-description">Easy to care for and excellent for air purification. very nice product </p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/fiddle.jpg" alt="Fiddle Leaf Fig">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Fiddle Leaf Fig</h3>
                            <p class="product-description">Popular indoor tree with large, violin-shaped leaves.very nice product</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/pothos.jpg" alt="Golden Pothos">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Golden Pothos</h3>
                            <p class="product-description">Trailing vine with heart-shaped, variegated leaves.very nice product</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/ZZ.jpg" alt="ZZ Plant">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">ZZ Plant</h3>
                            <p class="product-description">Hardy, drought-tolerant with glossy, dark green leaves.</p>
                            <div class="product-price">Rs. 1,350</div>
                            <button class="add-to-cart-btn">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/rubber.jpg" alt="Rubber Plant">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Rubber Plant</h3>
                            <p class="product-description">Dark, glossy leaves with burgundy undersides.very nice product</p>
                            <div class="product-price">Rs. 1,450</div>
                            <button class="add-to-cart-btn">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/calathea.jpg" alt="Calathea Orbifolia">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Calathea Orbifolia</h3>
                            <p class="product-description">Stunning striped foliage that moves throughout the day.</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/spider.jpg" alt="Spider Plant">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Spider Plant</h3>
                            <p class="product-description">Easy-care plant with arching leaves and baby plantlets.</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/aloevera.webp" alt="Aloe Vera">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Aloe Vera</h3>
                            <p class="product-description">Succulent with medicinal properties and spiky leaves.</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/Echeveria.jpg" alt="Echeveria Plant">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Echeveria Plant</h3>
                            <p class="product-description">Symbol of persistence and strength.</p>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            <img src="../image/indoor/bostorn.jpg" alt="Boston Fern">
                        </div>
                        <div class="product-info">
                            <h3 class="product-name">Boston Fern</h3>
                            <p class="product-description">Classic fern with feathery, arching fronds.</p>
